...
namespace Foody.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240716193426_ComposedKeyRemoved2")]
    partial class ComposedKeyRemoved2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foody.Core.Domain.Entities.DinnerTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Foody.Core.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Foody.Core.Domain.Entities.DishOrder", b =>
                {
                    ...
                    b.HasOne("Foody.Core.Domain.Entities.Order", "Order")
                        .WithMany("DishesOrders")
